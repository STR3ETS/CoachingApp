...
<form method="POST" action="{{ route('coach.plans.store') }}"
    ...
    <div class="grid md:grid-cols-3 gap-4 mb-6">
        <div class="md:col-span-2">
            ...
            <input x-model="title" name="title" class="w-full border rounded px-3 py-2" placeholder="Hyrox schema">
        </div>
        <div>
    ...
    <div class="mt-6 flex gap-3">
        ...
        <a href="{{ route('coach.plans.index') }}" class="px-4 py-2 border rounded">Annuleren</a>
    </div>
</form>
@endsection
